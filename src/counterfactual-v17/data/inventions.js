...
export const INVENTIONS = [
  {id:"printingpress",name:"Printing Press",born:1440,died:null,cat:"inventions",field:"Communication Technology",
    ...
    r:0.5,reasoning:"Gutenberg developed movable type, but Koreans had it earlier. Chinese invented printing centuries before. European conditions — commercial economy, alphabet, paper availability — made it transformative. Someone in Europe would have developed it soon.",
  ...
  {id:"wheel_inv",name:"The Wheel",born:-3500,died:null,cat:"inventions",field:"Mechanical",
    ...
    r:0.1,reasoning:"Multiple civilizations developed wheels independently — Mesopotamia, Indus Valley, likely others. The concept is intuitive from rolling logs. The specific timing could differ; the invention was inevitable given pottery and transport needs.",
  ...
  {id:"fire_inv",name:"Controlled Fire",born:-400000,died:null,cat:"inventions",field:"Fundamental Technology",
    ...
    r:0.05,reasoning:"Fire was discovered, not invented — natural fires exist. Multiple hominin species controlled fire independently. The knowledge spread and was rediscovered repeatedly. Completely inevitable given human observation.",
  ...
  {id:"electricity",name:"Practical Electricity",born:1879,died:null,cat:"inventions",field:"Energy Technology",
    ...
    r:0.2,reasoning:"Multiple inventors developed electric lighting — Swan in England, Yablochkov's arc lamps. Edison systematized it. AC power came from Tesla and Westinghouse. The components were being developed by dozens of researchers. Edison accelerated by years, not decades.",
  ...
  {id:"penicillin",name:"Penicillin",born:1928,died:null,cat:"inventions",field:"Medicine",
    ...
    r:0.25,reasoning:"Fleming noticed mold killing bacteria but didn't develop it. Florey and Chain made it usable. Multiple labs were investigating antibacterial agents. Sulfa drugs were already working. Antibiotics were coming; penicillin was one discovery among several.",
  ...
  {id:"vaccine",name:"Vaccination",born:1796,died:null,cat:"inventions",field:"Medicine",
    ...
    r:0.4,reasoning:"Variolation (using smallpox itself) was practiced for centuries. Folk knowledge about cowpox existed. Jenner systematized and legitimized it. Multiple people were experimenting. The specific path might differ but immunization concept was emerging.",
  ...
  {id:"internet",name:"The Internet",born:1969,died:null,cat:"inventions",field:"Communication Technology",
    ...
    r:0.4,reasoning:"Packet switching developed independently (Davies in UK, Baran in US). ARPANET was military-funded but university-driven. French Minitel showed alternative paths. Some global network was coming; the specific form (protocols, governance) was contingent.",
  ...
  {id:"telephone",name:"Telephone",born:1876,died:null,cat:"inventions",field:"Communication Technology",
    ...
    r:0.15,reasoning:"Gray filed a patent the same day as Bell. Meucci had earlier devices. Reis transmitted speech in 1861. Multiple inventors were converging. Bell won the patent race; the invention was coming regardless.",
  ...
  {id:"automobile",name:"Automobile",born:1886,died:null,cat:"inventions",field:"Transportation",
    ...
    r:0.25,reasoning:"Internal combustion engines were developed by multiple inventors. Benz, Daimler, and others were all building motorized vehicles in the 1880s. The specific form might vary, but personal motorized transport was coming.",
  ...
  {id:"airplane",name:"Airplane",born:1903,died:null,cat:"inventions",field:"Transportation",
    ...
    r:0.35,reasoning:"Multiple inventors were attempting powered flight. Santos-Dumont flew in 1906, disputed Wright's priority. Langley's attempt crashed nine days before Wrights succeeded. The engineering was becoming possible; the Wrights got there first through superior method.",
  ...
  {id:"computer",name:"Electronic Computer",born:1945,died:null,cat:"inventions",field:"Computing",
    ...
    r:0.45,reasoning:"Multiple teams built early computers simultaneously — ENIAC, Colossus, Z3, ABC. The theoretical foundations (Turing, von Neumann) were shared. No single inventor; the technology emerged from collective wartime and postwar effort.",
  ...
  {id:"transistor",name:"Transistor",born:1947,died:null,cat:"inventions",field:"Electronics",
    ...
    r:0.35,reasoning:"Solid-state physics was advancing globally. Bell Labs had resources, but European labs were pursuing similar research. The quantum mechanics that explains semiconductors was shared knowledge. Someone would have developed transistors within years.",
  ...
  {id:"steamengine",name:"Steam Engine",born:1712,died:null,cat:"inventions",field:"Energy Technology",
    ...
    r:0.5,reasoning:"Newcomen built first practical engine. Watt improved efficiency dramatically. The technology developed incrementally over decades with multiple contributors. Industrial Revolution's timing depended on this specific development path.",
  ...
  {id:"gunpowder",name:"Gunpowder",born:850,died:null,cat:"inventions",field:"Military Technology",
    ...
    r:0.55,reasoning:"Chinese alchemists discovered it accidentally. The formula spread via Silk Road. Eventually, someone would have mixed sulfur, charcoal, and saltpeter. But the specific timing of its invention shaped a millennium of warfare.",
  ...
  {id:"compass",name:"Magnetic Compass",born:1040,died:null,cat:"inventions",field:"Navigation",
    ...
    r:0.4,reasoning:"Chinese developed it first for feng shui, then navigation. Knowledge spread west. Europeans improved it for sea navigation. The magnetic properties of lodestone were known; application to navigation was logical progression.",
  ...
  {id:"paper",name:"Paper",born:105,died:null,cat:"inventions",field:"Communication Technology",
    ...
    r:0.45,reasoning:"Cai Lun credited with invention in China, though earlier forms existed. Writing surfaces were needed; papyrus, parchment served earlier. Paper's specific advantages (cheap, durable) would have been sought. Similar technology might have emerged elsewhere.",
  ...
  {id:"ironworking",name:"Iron Smelting",born:-1200,died:null,cat:"inventions",field:"Metallurgy",
    ...
    r:0.3,reasoning:"Hittites pioneered it, but iron working developed independently in multiple regions. The techniques spread and were rediscovered. Given meteoric iron's known properties, smelting would have been pursued eventually.",
  ...
  {id:"writing",name:"Writing",born:-3400,died:null,cat:"inventions",field:"Communication",
    ...
    r:0.5,reasoning:"Writing developed independently in Mesopotamia, Egypt, China, and Mesoamerica. The need to record transactions, laws, and religious texts drove multiple inventions. Completely inevitable once societies reached sufficient complexity.",
  ...
  {id:"clockwork",name:"Mechanical Clock",born:1280,died:null,cat:"inventions",field:"Timekeeping",
    ...
    r:0.45,reasoning:"Medieval monasteries drove demand for timekeeping (prayer hours). Water clocks and sundials existed. Mechanical escapement emerged in Europe from incremental improvements. Clock-making was advancing in multiple places.",
  ...
  {id:"telescope",name:"Telescope",born:1608,died:null,cat:"inventions",field:"Scientific Instruments",
    ...
    r:0.3,reasoning:"Lippershey credited with patent, but others were developing similar devices simultaneously. Lens-grinding was advancing; the combination was logical. Galileo improved it dramatically but didn't invent it.",
  ...
  {id:"microscope",name:"Microscope",born:1590,died:null,cat:"inventions",field:"Scientific Instruments",
    ...
    r:0.35,reasoning:"Multiple lens-makers developed compound microscopes around same time. Leeuwenhoek made single-lens versions that were better. The optical principles were understood; application was being pursued by many.",
  ...
  {id:"radio",name:"Radio",born:1895,died:null,cat:"inventions",field:"Communication Technology",
    ...
    r:0.3,reasoning:"Marconi, Tesla, Lodge, Popov, Bose all contributed to radio development. Maxwell's theory predicted it; Hertz demonstrated waves. Multiple inventors were converging on practical wireless. Someone would have succeeded within years.",
  ...
  {id:"television",name:"Television",born:1927,died:null,cat:"inventions",field:"Communication Technology",
    ...
    r:0.35,reasoning:"Multiple inventors developed television systems — Farnsworth, Zworykin, Baird. The concept was pursued by corporations and individuals globally. Electronic television would have emerged from any of several paths.",
  ...
  {id:"photography",name:"Photography",born:1826,died:null,cat:"inventions",field:"Visual Technology",
    ...
    r:0.45,reasoning:"Niépce, Daguerre, Talbot all developed photography methods around same time. The chemistry was advancing; camera obscura was ancient. Multiple approaches were being tried. Someone would have succeeded within a decade.",
  ...
  {id:"refrigeration",name:"Mechanical Refrigeration",born:1834,died:null,cat:"inventions",field:"Domestic Technology",
    ...
    r:0.4,reasoning:"Multiple inventors worked on mechanical cooling. Perkins, Gorrie, Carré developed different systems. The thermodynamic principles were understood. Commercial development would have proceeded via multiple paths.",
  ...
  {id:"anesthesia",name:"Anesthesia",born:1846,died:null,cat:"inventions",field:"Medicine",
    ...
    r:0.35,reasoning:"Morton, Wells, Long, and others all demonstrated anesthesia around same time. The properties of ether and nitrous oxide were known. Medical application was being pursued by multiple practitioners. Priority disputes show convergence.",
  ...
  {id:"antiseptic",name:"Antiseptic Technique",born:1867,died:null,cat:"inventions",field:"Medicine",
    ...
    r:0.45,reasoning:"Lister applied Pasteur's germ theory to surgery. Semmelweis had proven hand-washing worked earlier. Multiple doctors were recognizing infection sources. The connection between germs and surgery was being made; Lister systematized it.",
  ...
  {id:"xray",name:"X-Ray",born:1895,died:null,cat:"inventions",field:"Medical Technology",
    ...
    r:0.3,reasoning:"Röntgen discovered X-rays, but cathode ray tubes were being studied by many. Several others might have noticed the phenomenon soon — Lenard, Crookes came close. The discovery was imminent in the physics of the time.",
  ...
  {id:"nuclearpower",name:"Nuclear Power",born:1942,died:null,cat:"inventions",field:"Energy Technology",
    ...
    r:0.5,reasoning:"Manhattan Project assembled global talent, but nuclear physics was advancing in Germany, Britain, USSR. Fission was discovered in Germany. Nuclear power/weapons were coming; the specific timing and which nation first was contingent.",
  ...
  {id:"contraceptive",name:"Birth Control Pill",born:1960,died:null,cat:"inventions",field:"Medicine",
    ...
    r:0.5,reasoning:"Pincus and Rock developed it with funding from Sanger and McCormick. Hormonal contraception was being researched elsewhere. The specific timing reflected funding and regulatory choices. Other methods were advancing; hormonal control was coming.",
  ...
  {id:"semiconductor",name:"Integrated Circuit",born:1958,died:null,cat:"inventions",field:"Computing",
    ...
    r:0.3,reasoning:"Kilby and Noyce invented integrated circuits independently within months. The need was obvious; planar technology was advancing. Multiple paths would have led there. Someone would have integrated circuits onto chips very soon.",
  ...
  {id:"laser",name:"Laser",born:1960,died:null,cat:"inventions",field:"Physics Technology",
    ...
    r:0.35,reasoning:"Maiman built first laser, but Townes, Basov, Prokhorov developed theory (Nobel Prize). Multiple labs were racing to build one. The physics was understood; engineering was catch-up. Lasers would have emerged from multiple paths.",
  ...
  {id:"gps_inv",name:"GPS",born:1973,died:null,cat:"inventions",field:"Navigation Technology",
    ...
    r:0.45,reasoning:"GPS required government investment (US military). Soviet GLONASS developed independently. The concept — triangulation from satellites — was understood. Some nation would have built a positioning system; the specific timing and openness to civilians was policy choice.",
  ...
  {id:"mri",name:"MRI",born:1971,died:null,cat:"inventions",field:"Medical Technology",
    ...
    r:0.45,reasoning:"Damadian, Lauterbur, Mansfield all contributed. Nuclear magnetic resonance was known physics. Application to medical imaging was pursued by multiple groups. The technology would have emerged from the active research community.",
  ...
  {id:"dna_tech",name:"DNA Sequencing",born:1977,died:null,cat:"inventions",field:"Biotechnology",
    ...
    r:0.45,reasoning:"Sanger developed sequencing method; others developed alternatives. DNA structure was known; the need for sequencing was recognized. Multiple approaches were being developed. The specific method might differ but sequencing capability was coming.",
  ...
  {id:"crispr",name:"CRISPR Gene Editing",born:2012,died:null,cat:"inventions",field:"Biotechnology",
    ...
    r:0.5,reasoning:"Doudna and Charpentier discovered CRISPR's gene-editing potential, but the system existed in bacteria. Multiple labs were studying it. The specific application to editing was their insight, but CRISPR biology was being studied widely.",
  ...
  {id:"solar_pv",name:"Solar Photovoltaics",born:1954,died:null,cat:"inventions",field:"Energy Technology",
    ...
    r:0.4,reasoning:"Bell Labs developed first practical solar cell. Photovoltaic effect was known since 1839. Multiple labs worked on semiconductors. The specific efficiency breakthroughs came from Bell's silicon work, but solar research was active globally.",
  ...
  {id:"lithiumbattery",name:"Lithium-Ion Battery",born:1991,died:null,cat:"inventions",field:"Energy Storage",
    ...
    r:0.45,reasoning:"Goodenough, Whittingham, and Yoshino developed lithium-ion batteries over decades. Multiple paths were pursued. Sony commercialized. The chemistry was being explored by many; specific breakthroughs came from this team but battery research was broad.",
  ...
  {id:"wwweb",name:"World Wide Web",born:1989,died:null,cat:"inventions",field:"Communication Technology",
    ...
    r:0.55,reasoning:"Internet existed; hypertext existed (Xanadu, HyperCard). Berners-Lee combined them with URLs, HTTP, HTML in a way that worked. Others were building hypertext systems. His specific simple design enabled adoption. A different web might have been less open.",
  ...
  {id:"smartphone",name:"Smartphone",born:2007,died:null,cat:"inventions",field:"Personal Technology",
    ...
    r:0.4,reasoning:"PDAs and phones were converging. Blackberry had email phones. Touch screens existed. Apple's specific combination — multi-touch, App Store, design — was innovative integration. But smartphone evolution was happening; iPhone accelerated and shaped it.",
  ...
  {id:"3dprinting",name:"3D Printing",born:1984,died:null,cat:"inventions",field:"Manufacturing",
    ...
    r:0.45,reasoning:"Hull invented stereolithography; others developed different approaches (FDM, SLS). The concept of additive manufacturing was being explored in multiple ways. The technology would have emerged; specific methods might differ.",
  ...
  {id:"antibiotics_sulfa",name:"Sulfonamide Antibiotics",born:1935,died:null,cat:"inventions",field:"Medicine",
    ...
    r:0.4,reasoning:"Domagk discovered Prontosil's antibacterial effect. Dye chemistry was being explored for medical uses. The specific discovery was his, but antimicrobial research was active. Similar discoveries might have emerged from other dye research.",
  ...
  {id:"organ_transplant",name:"Organ Transplantation",born:1954,died:null,cat:"inventions",field:"Medicine",
    ...
    r:0.5,reasoning:"Murray performed first kidney transplant. Multiple surgeons attempted transplants. Immunology was advancing. The specific breakthroughs in tissue matching and immunosuppression involved many researchers. Transplantation would have developed via multiple paths.",
  ...
  {id:"ivf",name:"In Vitro Fertilization",born:1978,died:null,cat:"inventions",field:"Medicine",
    ...
    r:0.5,reasoning:"Edwards and Steptoe developed IVF over decades. Reproductive biology was advancing globally. The specific technique was their achievement, but the science was being pursued. IVF or similar assisted reproduction was coming.",
  ...
  {id:"pacemaker",name:"Cardiac Pacemaker",born:1958,died:null,cat:"inventions",field:"Medical Devices",
    ...
    r:0.4,reasoning:"Greatbatch invented implantable pacemaker; others developed external versions. Cardiac electrophysiology was advancing. The need was clear; technology was becoming available. Multiple paths would have led to pacemakers.",
  ...
  {id:"blockchain",name:"Blockchain",born:2008,died:null,cat:"inventions",field:"Computing",
    ...
    r:0.55,reasoning:"Satoshi Nakamoto combined existing cryptographic concepts (hash chains, proof of work) in novel way. The components existed; the specific combination creating Bitcoin was innovative. Decentralized currency concepts were being explored; this specific implementation succeeded.",
  ...
  {id:"ai_neural",name:"Deep Learning / Neural Networks",born:2012,died:null,cat:"inventions",field:"Computing",
    ...
    r:0.5,reasoning:"Deep learning breakthrough came from Hinton, LeCun, Bengio, but neural networks were known since 1950s. Computing power enabled their success. Multiple researchers contributed; the specific timing reflected hardware advances. AI progress was coming; this path accelerated it.",
  ...
  {id:"airconditioning",name:"Air Conditioning",born:1902,died:null,cat:"inventions",field:"Climate Control",
    ...
    r:0.45,reasoning:"Carrier developed modern AC, but cooling technology was being pursued by multiple inventors. Refrigeration principles were understood. Carrier's specific innovation was humidity control for printing. Air conditioning was emerging; his implementation succeeded.",
  ...
  {id:"concrete",name:"Reinforced Concrete",born:1853,died:null,cat:"inventions",field:"Construction",
    ...
    r:0.4,reasoning:"Romans had concrete. Multiple inventors developed reinforced concrete independently — Monier, Hennebique, Ransome. The combination of steel and concrete was being explored in multiple places. The technology was convergent.",
