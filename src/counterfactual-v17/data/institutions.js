...
export const INSTITUTIONS = [
  {id:"un",name:"United Nations",born:1945,died:null,cat:"institutions",field:"International Governance",
    ...
    r:0.65,reasoning:"League of Nations had failed, but international cooperation was needed. Post-WWII powers would have created some forum. A different organization would have emerged.",
  ...
  {id:"redcross",name:"Red Cross & Red Crescent Movement",born:1863,died:null,cat:"institutions",field:"Humanitarian Aid & Law",
    quote:"Even wars have limits.",
    contributions:["Geneva Conventions foundation & guardianship","Neutral prisoner visits in every modern conflict","Blood bank system","Disaster coordination across 192 national societies","Family tracing after wars and disasters"],
    r:0.7,reasoning:"Henry Dunant founded it after witnessing Battle of Solferino. The movement created three things no one else did: international humanitarian law (Geneva Conventions), the concept of neutral humanitarian space, and a global network of 192 national societies coordinating disaster response. Without Dunant, all three might have developed very differently.",
    counterfactual:"Without Henry Dunant witnessing the Battle of Solferino and being moved to action, the institutionalization of humanitarian aid might have been delayed by decades. The Geneva Conventions that govern warfare — protecting wounded soldiers, prisoners, civilians — might not exist. The ICRC's unique neutral status lets it visit prisoners and serve as go-between for warring parties; without that, wars have no neutral intermediary. The Federation's coordination of 192 national societies means disaster response is global and standardized; without it, every country improvises alone. War would be more brutal, disasters more chaotic, and millions of separated families would never reunite.",
    ripples:[
      ...
      {category:"Neutral Humanitarian Space",detail:"The model of neutral organizations operating in conflicts doesn't exist. Aid is always aligned with political powers. No one visits prisoners."},
      ...
      {category:"Family Tracing",detail:"After every war and disaster, the Red Cross reconnects separated families. Without them, millions never find their relatives."}
    ],
    timeline:[
      ...
      {year:1949,happened:"Fourth Geneva Convention protects civilians",alternate:"Civilian protection in war less established; more atrocities go unchecked"},
      {year:2020,happened:"192 national societies coordinate COVID response",alternate:"Humanitarian response more fragmented, less effective"}
    ],
    impact:{lives:"Billions aided since 1863",econ:"$5B+ annual operations across movement",cultural:"Neutral humanitarian symbol",reach:"192 national societies in virtually every country",timeline:"Humanitarian law develops much slower"},
    ...
    cascade:[
      ...
      {event:"No neutral intermediary in wars",consequence:"The ICRC serves as go-between for warring parties — prisoner exchanges, humanitarian corridors, ceasefire negotiations. Without them, every war is more total.",delay:"~50 years",severity:"high",icon:"🕊️"},
    ...
    modernDay:{
      tech:"The Red Cross symbol on your first aid kit, the blood donation system at your local hospital, the emergency response protocols your city uses — all Red Cross inheritances.",
      culture:"The idea that neutrality in war is even possible — that you can help both sides' wounded, visit both sides' prisoners — was radical. Without it, humanitarianism is always political.",
      politics:"The Geneva Conventions that govern every modern conflict are Red Cross creations. Guantanamo, Abu Ghraib — the ICRC was the only organization with access. Without them, international humanitarian law barely exists."
    }},
  {id:"gatesfoundation",name:"Gates Foundation",born:2000,died:null,cat:"institutions",field:"Global Health",
    ...
    r:0.55,reasoning:"Billionaire philanthropy existed before Gates, but no one deployed so much money so strategically on global health. Other billionaires had different priorities.",
  ...
  {id:"worldbank",name:"World Bank",born:1944,died:null,cat:"institutions",field:"Development Finance",
    ...
    r:0.45,reasoning:"Post-WWII reconstruction required institutional financing. Some development bank would have existed — specific form wasn't predetermined, but the need was clear.",
  ...
  {id:"who",name:"World Health Organization",born:1948,died:null,cat:"institutions",field:"Global Health",
    ...
    r:0.6,reasoning:"International health coordination existed before WHO. But WHO's specific achievement — smallpox eradication — required institutional capacity that might not have existed otherwise.",
  ...
  {id:"nato",name:"NATO",born:1949,died:null,cat:"institutions",field:"Military Alliance",
    ...
    r:0.65,reasoning:"Cold War created blocs regardless. Western Europe needed American security guarantees. But NATO's specific form wasn't inevitable. Different alliance might have meant different European security.",
  ...
  {id:"eu",name:"European Union",born:1993,died:null,cat:"institutions",field:"Political & Economic Union",
    ...
    r:0.75,reasoning:"European integration began with coal and steel, driven by Monnet and Schuman's vision. Different history might have stopped at free trade without political union.",
  ...
  {id:"imf",name:"International Monetary Fund",born:1944,died:null,cat:"institutions",field:"Financial Stability",
    ...
    r:0.5,reasoning:"Bretton Woods designed to prevent competitive devaluations. Some monetary coordination was needed. IMF's specific form was contested from start.",
  ...
  {id:"wwf",name:"World Wildlife Fund",born:1961,died:null,cat:"institutions",field:"Conservation",
    ...
    r:0.5,reasoning:"Conservation organizations existed, but WWF's strategy was distinctive. Environmental concern was growing regardless. WWF channeled it in specific directions.",
  ...
  {id:"amnesty",name:"Amnesty International",born:1961,died:null,cat:"institutions",field:"Human Rights",
    ...
    r:0.65,reasoning:"Human rights advocacy existed, but Amnesty's innovation was letter-writing campaigns. This model was replicable and powerful. Without Amnesty, human rights advocacy might have remained more elite.",
  ...
  {id:"opec",name:"OPEC",born:1960,died:null,cat:"institutions",field:"Energy",
    ...
    r:0.6,reasoning:"Oil-producing countries were being exploited. Collective action was logical. Without OPEC specifically, similar organization would emerge.",
  ...
  {id:"wto",name:"World Trade Organization",born:1995,died:null,cat:"institutions",field:"Trade",
    ...
    r:0.5,reasoning:"GATT already existed. Trade liberalization was the trend. WTO formalized what was happening. Without WTO, bilateral agreements would have multiplied.",
  ...
  {id:"oxfam",name:"Oxfam International",born:1942,died:null,cat:"institutions",field:"Development & Poverty",
    ...
    r:0.5,reasoning:"Humanitarian organizations existed. Oxfam's specific combination of emergency response, development, and advocacy was influential but replicable.",
  ...
  {id:"msf",name:"Médecins Sans Frontières",born:1971,died:null,cat:"institutions",field:"Medical Humanitarian",
    ...
    r:0.7,reasoning:"MSF's innovation was going where governments wouldn't — crossing borders without permission for medical emergencies. This model was new and has been widely copied.",
  ...
  {id:"greenpeace",name:"Greenpeace",born:1971,died:null,cat:"institutions",field:"Environmental Activism",
    ...
    r:0.55,reasoning:"Environmental activism existed. Greenpeace's direct action approach — confronting whalers, nuclear ships — was distinctive but would have emerged from the movement.",
  ...
  {id:"unicef",name:"UNICEF",born:1946,died:null,cat:"institutions",field:"Children's Aid",
    ...
    r:0.55,reasoning:"UN was creating specialized agencies. Children's aid was essential. Some agency would have formed. UNICEF's specific programs were influential but others could have done similar work.",
  ...
  {id:"unhcr",name:"UN Refugee Agency",born:1950,died:null,cat:"institutions",field:"Refugee Protection",
    ...
    r:0.55,reasoning:"Post-WWII refugee crisis demanded response. Some agency was needed. UNHCR's specific mandate has shaped refugee law, but alternatives existed.",
  ...
  {id:"wfp",name:"World Food Programme",born:1961,died:null,cat:"institutions",field:"Food Aid",
    ...
    r:0.55,reasoning:"Food aid existed before WFP. The program systematized and scaled it. Without WFP, food aid would be more fragmented but still happen.",
  ...
  {id:"icc",name:"International Criminal Court",born:2002,died:null,cat:"institutions",field:"International Justice",
    ...
    r:0.55,reasoning:"Ad hoc tribunals (Nuremberg, Yugoslavia, Rwanda) preceded ICC. Permanent court was logical evolution. Without ICC, ad hoc tribunals would continue.",
  ...
  {id:"iaea",name:"Int'l Atomic Energy Agency",born:1957,died:null,cat:"institutions",field:"Nuclear Regulation",
    ...
    r:0.55,reasoning:"Nuclear weapons spread required some oversight body. IAEA's specific mandate emerged from Cold War politics. Some organization was inevitable.",
  ...
  {id:"interpol",name:"Interpol",born:1923,died:null,cat:"institutions",field:"Law Enforcement",
    ...
    r:0.4,reasoning:"Police needed to cooperate across borders. Some coordination mechanism was inevitable. Interpol's specific form has evolved but wasn't unique solution.",
  ...
  {id:"fifa",name:"FIFA",born:1904,died:null,cat:"institutions",cat2:"sports",field:"Sports",
    ...
    r:0.3,reasoning:"Football was globalizing. Some governing body was needed. FIFA's specific structure emerged from European origins. A different organization would have formed.",
  ...
  {id:"olympics",name:"Int'l Olympic Committee",born:1894,died:null,cat:"institutions",cat2:"sports",field:"Sports",
    ...
    r:0.55,reasoning:"Athletic competition existed. Coubertin revived Olympics specifically. Without him, some international games would have emerged, but the specific form and brand might differ.",
  ...
  {id:"brac",name:"BRAC",born:1972,died:null,cat:"institutions",field:"Development",
    ...
    r:0.55,reasoning:"BRAC's scale in Bangladesh and model of integrated development was unique. Fazle Hasan Abed's vision was specific. Others did development; none at BRAC's scale or integration.",
  ...
  {id:"savechildren",name:"Save the Children",born:1919,died:null,cat:"institutions",field:"Children's Aid",
    ...
    r:0.45,reasoning:"Eglantyne Jebb founded it and wrote rights declaration. Children's aid organizations were emerging. Save the Children's longevity is notable but field was developing.",
  ...
  {id:"worldvision",name:"World Vision",born:1950,died:null,cat:"institutions",field:"Humanitarian Aid",
    ...
    r:0.4,reasoning:"Christian humanitarian organizations existed. World Vision's child sponsorship model was influential but not unique. Similar organizations emerged.",
  ...
  {id:"aclu",name:"ACLU",born:1920,died:null,cat:"institutions",field:"Civil Liberties",
    ...
    r:0.6,reasoning:"Civil liberties needed defense in the US. Some organization would have emerged. ACLU's specific cases and approach have shaped American law significantly.",
  ...
  {id:"naacp",name:"NAACP",born:1909,died:null,cat:"institutions",field:"Civil Rights",
    ...
    r:0.7,reasoning:"African American organizing was happening. The NAACP's specific legal strategy — test cases building toward Brown — was distinctive and successful. Different organizations might have taken different paths.",
  ...
  {id:"unesco",name:"UNESCO",born:1945,died:null,cat:"institutions",field:"Culture & Education",
    ...
    r:0.5,reasoning:"UN was creating specialized agencies. Cultural and educational cooperation needed a forum. UNESCO's specific programs matter, but some agency would exist.",
  ...
  {id:"habitat",name:"UN-Habitat",born:1978,died:null,cat:"institutions",field:"Urban Development",
    ...
    r:0.3,reasoning:"Urbanization was happening regardless. UN-Habitat has influenced policy but urban development would proceed. Its specific programs carried modest weight.",
  ...
  {id:"rotary",name:"Rotary International",born:1905,died:null,cat:"institutions",field:"Service Organization",
    ...
    r:0.35,reasoning:"Service clubs were emerging. Rotary's specific model was influential but Lions, Kiwanis developed similarly. The service club concept would have spread.",
  ...
  {id:"nature",name:"The Nature Conservancy",born:1951,died:null,cat:"institutions",field:"Conservation",
    ...
    r:0.45,reasoning:"Land trusts existed. TNC's scale and corporate partnership model was distinctive but land conservation would have happened through other vehicles.",
  ...
  {id:"hrw",name:"Human Rights Watch",born:1978,died:null,cat:"institutions",field:"Human Rights",
    ...
    r:0.55,reasoning:"Human rights documentation was needed. HRW's investigative model built on and competed with Amnesty. The field was developing; HRW shaped its direction.",
  ...
  {id:"cern",name:"CERN",born:1954,died:null,cat:"institutions",field:"Scientific Research",
    ...
    r:0.65,reasoning:"European physics needed big science cooperation. CERN's specific achievements — Higgs, WWW — were products of this institution. Without CERN, particle physics advances differently.",
  ...
  {id:"ieee",name:"IEEE",born:1884,died:null,cat:"institutions",field:"Technology Standards",
    ...
    r:0.35,reasoning:"Engineering societies were forming globally. Standards bodies were needed. IEEE's specific standards are influential but alternatives would have emerged.",
  ...
  {id:"wikimedia",name:"Wikimedia Foundation",born:2003,died:null,cat:"institutions",field:"Knowledge",
    ...
    r:0.55,reasoning:"Jimmy Wales and Larry Sanger's specific vision created Wikipedia. The open content movement was broader, but Wikipedia's model and success were distinctive achievements.",
  ...
  {id:"rockefeller",name:"Rockefeller Foundation",born:1913,died:null,cat:"institutions",field:"Philanthropy",
    ...
    r:0.65,reasoning:"Modern philanthropy was developing. Rockefeller Foundation's specific programs — hookworm eradication, Green Revolution — were influential. Others might have funded differently.",
  ...
  {id:"fordfd",name:"Ford Foundation",born:1936,died:null,cat:"institutions",field:"Social Change",
    ...
    r:0.45,reasoning:"Large foundations were emerging. Ford's specific focus on social justice and international development was influential but the philanthropic sector was growing broadly.",
  ...
  {id:"nih",name:"National Institutes of Health",born:1887,died:null,cat:"institutions",field:"Medical Research",
    ...
    r:0.65,reasoning:"Government medical research was needed. Other countries developed their own systems. NIH's scale ($45B+) and model were influential; biomedical research would have proceeded but differently.",
  ...
  {id:"undp",name:"UN Development Programme",born:1966,died:null,cat:"institutions",field:"Development",
    ...
    r:0.4,reasoning:"UN development work needed coordination. Some program would have existed. UNDP's specific contribution was the Human Development Index — reframing development beyond GDP.",
  ...
  {id:"irc",name:"International Rescue Committee",born:1933,died:null,cat:"institutions",field:"Refugee Aid",
    ...
    r:0.45,reasoning:"Refugee organizations were forming. IRC's founding to help refugees fleeing Hitler was specific to moment. Similar organizations would have emerged for subsequent crises.",
  ...
  {id:"mercycorps",name:"Mercy Corps",born:1979,died:null,cat:"institutions",field:"Humanitarian Aid",
    ...
    r:0.35,reasoning:"Humanitarian organizations proliferated. Mercy Corps' market-based approach was distinctive but the sector was growing. Similar organizations would have filled its niche.",
  ...
  {id:"wef",name:"World Economic Forum",born:1971,died:null,cat:"institutions",field:"Global Governance",
    ...
    r:0.4,reasoning:"Elite global gatherings were happening. Klaus Schwab's specific vision shaped WEF, but similar forums would have emerged. The function of elite networking would be filled.",
  ...
  {id:"aspen",name:"Aspen Institute",born:1949,died:null,cat:"institutions",field:"Policy & Leadership",
    ...
    r:0.25,reasoning:"Policy institutes were forming. Aspen's specific humanities-based leadership model was distinctive but think tanks and leadership programs proliferated regardless.",
  ...
  {id:"cfr",name:"Council on Foreign Relations",born:1921,died:null,cat:"institutions",field:"Foreign Policy",
    ...
    r:0.45,reasoning:"Foreign policy elites needed a forum. CFR served this function in the US. Other countries developed their own institutes. The function would be served somehow.",
  ...
  {id:"brookings",name:"Brookings Institution",born:1916,died:null,cat:"institutions",field:"Policy Research",
    ...
    r:0.35,reasoning:"Think tanks were forming in the US. Brookings was influential in shaping policy research norms, but the sector was developing. Similar institutions would have emerged.",
  ...
  {id:"rand",name:"RAND Corporation",born:1948,died:null,cat:"institutions",field:"Research & Analysis",
    ...
    r:0.5,reasoning:"Cold War demanded policy analysis. RAND pioneered systems analysis that spread globally. Military-academic complex was forming anyway, but RAND's specific contributions shaped how governments think.",
  ...
  {id:"carnegieendow",name:"Carnegie Endowment for International Peace",born:1910,died:null,cat:"institutions",field:"International Affairs",
    ...
    r:0.35,reasoning:"Peace research institutions were forming. Carnegie was early and influential but the field developed through multiple organizations.",
  ...
  {id:"trilateral",name:"Trilateral Commission",born:1973,died:null,cat:"institutions",field:"International Relations",
    ...
    r:0.25,reasoning:"Elite coordination was happening through multiple channels. Trilateral formalized one version, but similar networks existed. Its influence is often overstated.",
  ...
  {id:"heritage",name:"Heritage Foundation",born:1973,died:null,cat:"institutions",field:"Conservative Policy",
    ...
    r:0.4,reasoning:"Conservative think tanks were forming. Heritage's specific innovation was quick policy briefs for legislators. The conservative intellectual movement would have found institutional form regardless.",
