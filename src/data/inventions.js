...
export const INVENTIONS = [
  {id:"printingpress",name:"Printing Press",born:1440,died:null,cat:"inventions",field:"Communication Technology",
    quote:"The printing press is the greatest weapon in the armoury of the modern commander. â€” T.E. Lawrence",
    contributions:["Mass book production","Literacy spread","Scientific Revolution catalyst","Protestant Reformation enabled"],
    r:0.50,reasoning:"Gutenberg developed movable type, but Koreans had it earlier. Chinese invented printing centuries before. European conditions â€” commercial economy, alphabet, paper availability â€” made it transformative. Someone in Europe would have developed it soon.",
    counterfactual:"Without Gutenberg, movable type still reaches Europe â€” it already existed in Korea, and European conditions (alphabetic writing, commercial economy, paper availability) were ripe. But the delay of 20-50 years matters enormously. The Protestant Reformation might happen without printed pamphlets spreading Luther's ideas. The Scientific Revolution might be delayed. The specific trajectory of modernity â€” mass literacy, democratized knowledge â€” unfolds differently.",
    ripples:[
  ...
  {id:"wheel_inv",name:"The Wheel",born:-3500,died:null,cat:"inventions",field:"Mechanical",
    ...
    r:0.90,reasoning:"Multiple civilizations developed wheels independently â€” Mesopotamia, Indus Valley, likely others. The concept is intuitive from rolling logs. The specific timing could differ; the invention was inevitable given pottery and transport needs.",
    counterfactual:"Without the wheel in Mesopotamia, it's invented elsewhere â€” perhaps Indus Valley, perhaps China, perhaps independently multiple times. The concept is observable from rolling logs. But the delay matters: pottery develops differently, chariots arrive later, the gears that drive all machinery come slower. Pre-Columbian Americas developed sophisticated civilizations without wheels for transport, showing alternative paths exist.",
    ripples:[
  ...
  {id:"fire_inv",name:"Controlled Fire",born:-400000,died:null,cat:"inventions",field:"Fundamental Technology",
    ...
    timeline:[
      ...
      {year:2025,happened:"Fire remains fundamental technology",alternate:"No change â€” fire control was inevitable"}
    ],
  ...
  {id:"penicillin",name:"Penicillin",born:1928,died:null,cat:"inventions",field:"Medicine",
    quote:"One sometimes finds what one is not looking for. â€” Alexander Fleming",
    ...
    counterfactual:"Without Fleming's accidental discovery, antibiotics still arrive â€” sulfa drugs were already working by 1935, and multiple labs were investigating antibacterial agents. Penicillin might be discovered later (the mold is common), or different antibiotics might dominate first. The antibiotic era still begins, but perhaps with streptomycin or another compound leading. The specific trajectory differs; the revolution happens regardless.",
    ripples:[
  ...
  {id:"vaccine",name:"Vaccination",born:1796,died:null,cat:"inventions",field:"Medicine",
    quote:"The deviation of man from the state in which he was originally placed by nature seems to have proved to him a prolific source of diseases. â€” Edward Jenner",
    ...
    counterfactual:"Without Jenner, vaccination still emerges â€” variolation was already practiced, folk knowledge about cowpox protecting milkmaids existed, and others were experimenting. But Jenner's systematization and promotion were valuable. The concept might take 20 more years to become accepted science. Smallpox eradication is delayed. The paradigm of preventive medicine develops from different roots.",
    ripples:[
  ...
  {id:"internet",name:"The Internet",born:1969,died:null,cat:"inventions",field:"Communication Technology",
    quote:"The Internet is becoming the town square for the global village of tomorrow. â€” Bill Gates",
    ...
    counterfactual:"Without ARPANET, global computer networks still emerge â€” the British NPL network, French Minitel, and various corporate networks showed alternative paths. Packet switching was invented independently by Davies and Baran. But the specific protocols (TCP/IP), the open architecture, the academic culture that shaped the early internet â€” these might be different. A more commercial, less open network might have emerged. The web might look very different.",
    ripples:[
  ...
  {id:"telephone",name:"Telephone",born:1876,died:null,cat:"inventions",field:"Communication Technology",
    quote:"Mr. Watson, come here, I want to see you. â€” Alexander Graham Bell",
  ...
  {id:"automobile",name:"Automobile",born:1886,died:null,cat:"inventions",field:"Transportation",
    quote:"Nothing has spread socialistic feeling more than the automobile. â€” Will Rogers",
    ...
    counterfactual:"Without Benz, the automobile still arrives â€” Daimler, Maybach, and others were all building motorized vehicles in the 1880s. Internal combustion engines were being refined by many inventors. The car might take slightly different form (perhaps Otto's designs dominate), but personal motorized transport was coming. The oil economy, suburban development, and car culture all still emerge.",
    ripples:[
  ...
  {id:"airplane",name:"Airplane",born:1903,died:null,cat:"inventions",field:"Transportation",
    quote:"For once you have tasted flight you will walk the earth with your eyes turned skyward. â€” Leonardo da Vinci",
  ...
  {id:"computer",name:"Electronic Computer",born:1945,died:null,cat:"inventions",field:"Computing",
    quote:"A computer would deserve to be called intelligent if it could deceive a human into believing that it was human. â€” Alan Turing",
    contributions:["Digital revolution","Automation enabled","Internet possible","AI foundation"],
    r:0.55,reasoning:"Multiple teams built early computers simultaneously â€” ENIAC, Colossus, Z3, ABC. The theoretical foundations (Turing, von Neumann) were shared. No single inventor; the technology emerged from collective wartime and postwar effort.",
    counterfactual:"Without any single team, electronic computers still emerge â€” ENIAC, Colossus, Z3, ABC were all developed semi-independently during WWII. The theoretical foundations (Turing, von Neumann) were shared across the field. No single inventor was essential; the technology emerged from collective wartime necessity. The digital revolution still happens, perhaps with different initial architectures.",
    ripples:[
  ...
  {id:"transistor",name:"Transistor",born:1947,died:null,cat:"inventions",field:"Electronics",
    quote:"The transistor was probably the most important invention of the 20th century. â€” Nobel Committee",
  ...
  {id:"steamengine",name:"Steam Engine",born:1712,died:null,cat:"inventions",field:"Energy Technology",
    quote:"I sell here, Sir, what all the world desires to have â€” power. â€” Matthew Boulton",
    ...
    counterfactual:"Without Newcomen and Watt, the steam engine still arrives â€” the principles were understood, and mine flooding was a pressing problem driving innovation. But the specific timing matters enormously. A 20-40 year delay in efficient steam power delays the entire Industrial Revolution. Factories remain water-powered longer. Railroads arrive later. Britain's industrial dominance might be less complete, giving other nations more time to catch up.",
    ripples:[
  ...
  {id:"gunpowder",name:"Gunpowder",born:850,died:null,cat:"inventions",field:"Military Technology",
    ...
    ripples:[
      ...
      {category:"Social Structure",detail:"'Gunpowder made all men the same height' â€” without it, aristocratic warriors remain dominant longer."},
  ...
  {id:"writing",name:"Writing",born:-3400,died:null,cat:"inventions",field:"Communication",
    ...
    counterfactual:"Without Sumerian cuneiform, writing still emerges â€” it developed independently in Egypt, China, and Mesoamerica. The need to record transactions, laws, and religious texts drove multiple inventions. Writing was inevitable once societies reached sufficient complexity. But if somehow prevented everywhere, human civilization remains fundamentally oral. No history, no accumulated law, no science as we know it. Inconceivable.",
    ripples:[
  ...
  {id:"clockwork",name:"Mechanical Clock",born:1280,died:null,cat:"inventions",field:"Timekeeping",
    ...
    ripples:[
      ...
      {category:"Cultural Concept",detail:"'Time is money' â€” the modern sense of time as scarce commodity arrives later."}
    ],
    timeline:[
  ...
  {id:"telescope",name:"Telescope",born:1608,died:null,cat:"inventions",field:"Scientific Instruments",
    quote:"I have observed the Milky Way to be nothing else but a mass of innumerable stars. â€” Galileo",
  ...
  {id:"microscope",name:"Microscope",born:1590,died:null,cat:"inventions",field:"Scientific Instruments",
    ...
    counterfactual:"Without early compound microscopes, similar devices emerge from other lens-makers â€” the optical principles were understood, and multiple inventors were experimenting. Leeuwenhoek's single-lens microscopes were actually better and came later. The invisible world is revealed within a decade regardless. Cell theory and germ theory might be slightly delayed but were coming.",
    ripples:[
  ...
  {id:"radio",name:"Radio",born:1895,died:null,cat:"inventions",field:"Communication Technology",
    quote:"Radio is a medium of entertainment which permits millions of people to listen to the same joke at the same time. â€” T.S. Eliot",
  ...
  {id:"television",name:"Television",born:1927,died:null,cat:"inventions",field:"Communication Technology",
    quote:"Television is the first truly democratic culture. â€” Paddy Chayefsky",
    contributions:["Visual broadcasting","Home entertainment","News delivery","Political campaigns transformed"],
    r:0.65,reasoning:"Multiple inventors developed television systems â€” Farnsworth, Zworykin, Baird. The concept was pursued by corporations and individuals globally. Electronic television would have emerged from any of several paths.",
  ...
  {id:"photography",name:"Photography",born:1826,died:null,cat:"inventions",field:"Visual Technology",
    quote:"The camera is an instrument that teaches people how to see without a camera. â€” Dorothea Lange",
    contributions:["Visual documentation","Art form creation","Journalism transformed","Memory preservation"],
    r:0.55,reasoning:"NiÃ©pce, Daguerre, Talbot all developed photography methods around same time. The chemistry was advancing; camera obscura was ancient. Multiple approaches were being tried. Someone would have succeeded within a decade.",
    counterfactual:"Photography was simultaneously invented by multiple people. NiÃ©pce, Daguerre, and Talbot all developed photographic processes in the 1820s-30s. The underlying chemistry â€” light-sensitive silver compounds â€” was known. The camera obscura was ancient. Multiple experimenters were trying to fix images. Someone would have succeeded within a decade. The daguerreotype vs. calotype competition shows how multiple approaches were viable.",
    ripples:[
      {category:"Timing",detail:"Photography arrives within 10 years regardless. Different inventor, different name for the process."},
      {category:"Technical Path",detail:"Different process might dominate early â€” positive vs. negative might develop differently."},
    ...
    timeline:[
      {year:1826,happened:"First permanent photograph (NiÃ©pce)",alternate:"Similar achievement within a decade by others"},
  ...
  {id:"refrigeration",name:"Mechanical Refrigeration",born:1834,died:null,cat:"inventions",field:"Domestic Technology",
    ...
    r:0.60,reasoning:"Multiple inventors worked on mechanical cooling. Perkins, Gorrie, CarrÃ© developed different systems. The thermodynamic principles were understood. Commercial development would have proceeded via multiple paths.",
    counterfactual:"Refrigeration was invented by multiple people through different approaches. Perkins, Gorrie, CarrÃ©, and others all developed cooling systems. The thermodynamics were understood; the engineering was the challenge. Someone would have created practical refrigeration within 10-20 years. The specific refrigerant and system design might differ, but the cold chain â€” transforming food distribution, diet, medicine â€” was coming.",
    ripples:[
      {category:"Timing",detail:"Refrigeration arrives within 10-20 years regardless. Different inventor, different system design."},
      {category:"Technology",detail:"Different refrigerant might dominate. CFC vs. ammonia vs. other coolants â€” path might differ."},
      {category:"Food System",detail:"The transformation of diet and food distribution happens regardless. Same profound impact."},
      {category:"Medicine",detail:"Vaccine cold chain, blood storage, etc. â€” same medical benefits under any path."}
    ],
    timeline:[
  ...
  {id:"anesthesia",name:"Anesthesia",born:1846,died:null,cat:"inventions",field:"Medicine",
    quote:"We have conquered pain. â€” John Collins Warren",
    ...
    ripples:[
      ...
      {category:"Technique",detail:"Different agent might dominate initially â€” nitrous oxide vs. ether vs. chloroform."},
  ...
  {id:"antiseptic",name:"Antiseptic Technique",born:1867,died:null,cat:"inventions",field:"Medicine",
    quote:"There are people who do not object to eating a mutton chop, but who would be shocked at swallowing its germs. â€” Joseph Lister",
  ...
  {id:"xray",name:"X-Ray",born:1895,died:null,cat:"inventions",field:"Medical Technology",
    quote:"I have discovered something interesting, but I do not know whether or not my observations are correct. â€” Wilhelm RÃ¶ntgen",
    contributions:["Medical imaging revolution","Diagnostic capability","Security scanning","Structural analysis"],
    r:0.70,reasoning:"RÃ¶ntgen discovered X-rays, but cathode ray tubes were being studied by many. Several others might have noticed the phenomenon soon â€” Lenard, Crookes came close. The discovery was imminent in the physics of the time.",
    counterfactual:"X-rays were about to be discovered by someone. Lenard, Crookes, and others were studying cathode rays and came very close â€” Crookes noticed fogged photographic plates but didn't investigate. The phenomenon was sitting there waiting to be noticed. RÃ¶ntgen happened to investigate systematically. Within 5 years, someone would have made the same discovery. The revolution in medical imaging was imminent.",
    ripples:[
    ...
    timeline:[
      {year:1895,happened:"RÃ¶ntgen discovers X-rays",alternate:"Lenard, Crookes, or another discovers within 5 years"},
  ...
  {id:"nuclearpower",name:"Nuclear Power",born:1942,died:null,cat:"inventions",field:"Energy Technology",
    quote:"The release of atomic energy has not created a new problem. It has merely made more urgent the necessity of solving an existing one. â€” Einstein",
    ...
    ripples:[
      ...
      {category:"Nuclear Age",detail:"Same eventual nuclear age â€” the physics was known. Different political circumstances."},
  ...
  {id:"semiconductor",name:"Integrated Circuit",born:1958,died:null,cat:"inventions",field:"Computing",
    quote:"What we didn't realize then was that the integrated circuit would reduce the cost of electronic functions by a factor of a million. â€” Jack Kilby",
  ...
  {id:"gps_inv",name:"GPS",born:1973,died:null,cat:"inventions",field:"Navigation Technology",
    quote:"GPS has saved more lives than any other technology. â€” Bradford Parkinson",
    contributions:["Global positioning","Navigation transformed","Logistics revolution","Location-based services"],
    r:0.55,reasoning:"GPS required government investment (US military). Soviet GLONASS developed independently. The concept â€” triangulation from satellites â€” was understood. Some nation would have built a positioning system; the specific timing and openness to civilians was policy choice.",
    counterfactual:"Satellite positioning was independently developed by the US (GPS) and USSR (GLONASS). The concept was obvious once satellites existed. Without the US program, GLONASS might dominate. Without both, satellite navigation is delayed but comes eventually. The crucial decision â€” making GPS available to civilians in 1983 after KAL 007 â€” was a policy choice. A different nation's system might be less open.",
    ripples:[
  ...
  {id:"greenrevolution",name:"Green Revolution (High-Yield Crops)",born:1960,died:null,cat:"inventions",field:"Agriculture",
    quote:"The destiny of world civilization depends upon providing a decent standard of living for all mankind. â€” Norman Borlaug",
    ...
    counterfactual:"The Green Revolution was less inevitable than it seems. Borlaug's specific breeding work â€” dwarf wheat varieties that didn't fall over when heavily fertilized â€” was his contribution. Without him and the Rockefeller Foundation funding, the Asian famines predicted for the 1970s might have happened. Hundreds of millions might have died. Similar agricultural research was happening, but not at the same scale or speed. This is one case where a single person's work might have saved a billion lives.",
    ripples:[
  ...
  {id:"dna_tech",name:"DNA Sequencing",born:1977,died:null,cat:"inventions",field:"Biotechnology",
    quote:"DNA is like a computer program but far, far more advanced than any software ever created. â€” Bill Gates",
  ...
  {id:"crispr",name:"CRISPR Gene Editing",born:2012,died:null,cat:"inventions",field:"Biotechnology",
    ...
    counterfactual:"CRISPR as a bacterial immune system was being studied by multiple labs. Doudna and Charpentier made the crucial insight: this system could be reprogrammed to edit any gene. Without them, someone else makes this connection within 5 years â€” the system was too interesting, too active a research area. The gene editing revolution happens on similar timeline. The specific Nobel laureates might differ.",
    ripples:[
      {category:"Timing",detail:"Gene editing via CRISPR arrives within 5 years regardless. Different researchers get Nobel."},
      {category:"Applications",detail:"Same applications â€” disease treatment, agriculture, ethical debates."},
  ...
  {id:"solar_pv",name:"Solar Photovoltaics",born:1954,died:null,cat:"inventions",field:"Energy Technology",
    quote:"I'd put my money on the sun and solar energy. What a source of power! â€” Thomas Edison",
  ...
  {id:"wwweb",name:"World Wide Web",born:1989,died:null,cat:"inventions",field:"Communication Technology",
    quote:"The Web as I envisaged it, we have not seen it yet. â€” Tim Berners-Lee",
    ...
    counterfactual:"Without the World Wide Web, the internet still exists â€” it was there before Berners-Lee. But his specific combination of URLs, HTTP, and HTML created something simple enough to go viral. Without it, the internet might remain academic and technical longer, or a different hypertext system (Gopher, Xanadu) might win. That alternative web might be more centralized, less open, differently structured. The web we got was shaped by Berners-Lee's decision to make it free and open.",
    ripples:[
      ...
      {category:"Structure",detail:"URLs, links, the page model â€” all could have been different. Different web, different internet culture."}
    ],
    timeline:[
  ...
  {id:"smartphone",name:"Smartphone",born:2007,died:null,cat:"inventions",field:"Personal Technology",
    ...
    r:0.60,reasoning:"PDAs and phones were converging. Blackberry had email phones. Touch screens existed. Apple's specific combination â€” multi-touch, App Store, design â€” was innovative integration. But smartphone evolution was happening; iPhone accelerated and shaped it.",
    counterfactual:"Without the iPhone, smartphones still come â€” Blackberry, Palm, Windows Mobile were all moving this direction. But Apple's specific design choices shaped what smartphones became: multi-touch interface, App Store model, the specific form factor. Without iPhone, smartphones might be more Blackberry-like (keyboards, business focus) or take longer to reach mass consumers. Android might dominate from the start with different design language.",
    ripples:[
  ...
  {id:"antibiotics_sulfa",name:"Sulfonamide Antibiotics",born:1935,died:null,cat:"inventions",field:"Medicine",
    quote:"This is the greatest thing since the discovery of fire. â€” Winston Churchill (on sulfa drugs)",
  ...
  {id:"ivf",name:"In Vitro Fertilization",born:1978,died:null,cat:"inventions",field:"Medicine",
    quote:"Every child born through IVF is special. â€” Robert Edwards",
    ...
    counterfactual:"Without Edwards and Steptoe, assisted reproduction still develops â€” reproductive biology was advancing. But their specific technique, refined over decades, produced Louise Brown in 1978. Without them, IVF might come 5-10 years later through other researchers. The 8 million people born through IVF by 2024 might be fewer, or born later. Infertility treatment advances regardless; this specific technique's timing changes.",
    ripples:[
  ...
  {id:"blockchain",name:"Blockchain",born:2008,died:null,cat:"inventions",field:"Computing",
    ...
    counterfactual:"Without Satoshi's blockchain/Bitcoin, decentralized currency concepts were being explored â€” cypherpunks had discussed digital cash for decades. But Satoshi's specific combination of hash chains, proof of work, and economic incentives actually worked where others failed. Without it, cryptocurrency might come later, differently, or possibly not at all in recognizable form. The 'crypto' phenomenon as we know it â€” including Ethereum, DeFi, NFTs â€” doesn't happen the same way.",
    ripples:[
      ...
      {category:"Ecosystem",detail:"No Ethereum, no DeFi, no NFTs â€” or very different versions."},
  ...
  {id:"ai_neural",name:"Deep Learning / Neural Networks",born:2012,died:null,cat:"inventions",field:"Computing",
    ...
    ripples:[
      ...
      {category:"Applications",detail:"Self-driving cars, image recognition â€” same goals pursued differently."},
  ...
  {id:"concrete",name:"Reinforced Concrete",born:1853,died:null,cat:"inventions",field:"Construction",
    ...
    r:0.60,reasoning:"Romans had concrete. Multiple inventors developed reinforced concrete independently â€” Monier, Hennebique, Ransome. The combination of steel and concrete was being explored in multiple places. The technology was convergent.",
    counterfactual:"Without any single inventor, reinforced concrete still emerges â€” Monier, Hennebique, Ransome, and others were all developing it independently. The Romans had concrete; iron reinforcement was being added by multiple experimenters. This is one of the most convergent inventions: the technology was coming regardless of who got credit. The specific patents and timing might vary, but modern construction would still use reinforced concrete.",
    ripples:[
      ...
      {category:"Modern Cities",detail:"Skyscrapers, infrastructure, dams â€” all possible with or without specific inventor."},
