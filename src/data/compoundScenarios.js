// Compound scenarios â€” remove multiple figures at once
export const COMPOUND_SCENARIOS = [
  {
    ...
    compoundEffect: "Without Newton's mechanics, Maxwell's electromagnetism, and Einstein's relativity, the physical sciences are set back by a century or more. The Scientific Revolution still happens â€” Galileo, Kepler, and Leibniz ensure that â€” but the grand unification of physics never occurs in the 18th or 19th century. Electricity is discovered empirically in the 1800s but understood theoretically only in the 1900s. Nuclear physics doesn't exist until perhaps the 2000s. The atomic bomb is never built in the 20th century. No satellites, no GPS, no cell phones. The world in 2026 looks like the 1950s technologically.",
    modernWorld: [
      {area: "Technology", detail: "No nuclear power, no satellites, no GPS, no cell phones. Radio exists (discovered empirically) but television is more primitive. Computers exist but are much less powerful â€” transistor physics relies on quantum mechanics that hasn't been fully developed."},
      {area: "War", detail: "WWII ends differently â€” no atomic bomb. The invasion of Japan proceeds. The Cold War either doesn't happen or is purely conventional. No nuclear deterrence means major power wars are more likely."},
  ...
  },
  {
    ...
    compoundEffect: "Without Turing's theoretical foundations, Von Neumann's architecture, and Berners-Lee's web, computing develops much more slowly and never achieves its current form. Calculating machines exist â€” Babbage's ideas eventually get built â€” but the stored-program concept takes decades longer to emerge. By 2025, computers exist but are mainframe-era: large, expensive, institutional. No personal computers, no internet, no web. Information is stored on paper and microfilm. Communication is telephone and fax.",
    modernWorld: [
      {area: "Work", detail: "Office work is paper-based. Typewriters, filing cabinets, carbon copies. Accounting uses adding machines. Engineering calculations done by teams of human 'computers' â€” the job title."},
  ...
  },
  {
    ...
    modernWorld: [
      ...
      {area: "Race Relations", detail: "The United States and South Africa achieve similar legal outcomes â€” civil rights, end of apartheid â€” but through more confrontational processes. The reconciliation narratives are weaker. Racial tensions in both countries are arguably sharper."},
  ...
  },
  {
    ...
    compoundEffect: "Remove both the printing press and the internet and you've eliminated the two great democratizations of information in human history. Knowledge stays in the hands of scribes, priests, and elites for centuries longer. When mechanical printing eventually arrives (someone invents it), it does so without the internet to amplify it. Mass literacy develops, but the second revolution â€” anyone can publish to everyone â€” never happens.",
    modernWorld: [
      ...
      {area: "Power", detail: "Without mass self-publishing, institutional gatekeepers â€” governments, media corporations, universities â€” maintain enormous control over information. Dissent is harder to organize. Propaganda is harder to counter."},
  ...
  },
  {
    ...
    compoundEffect: "Remove history's three greatest conquerors and the political map of the world is unrecognizable. The Mongol Empire never connects East and West. Alexander never spreads Greek culture across Persia and Egypt. Napoleon never reshapes Europe's legal and political order. Empires still form â€” the impulse is human â€” but these specific, personality-driven explosions of conquest don't happen.",
    modernWorld: [
      {area: "Geography", detail: "The Middle East likely remains the world's intellectual center much longer (no Mongol destruction of Baghdad). Europe's political fragmentation persists â€” no Napoleon to dissolve the Holy Roman Empire. Hellenistic culture never penetrates Central Asia."},
      {area: "Law", detail: "No Napoleonic Code means European civil law develops from a patchwork of local traditions. No Alexander means Greek philosophy doesn't reach Persia and India in the same way â€” the intellectual cross-pollination is weaker."},
  ...
  },
  {
    ...
    compoundEffect: "Strip out the three pillars of Western intellectual method and the entire trajectory of European thought changes. Plato's academy â€” the template for the university â€” never exists. Aristotle's systematic classification of knowledge (logic, biology, ethics, politics) never provides the scaffolding that medieval scholars build on. Euclid's axiomatic method â€” the idea that you can derive complex truths from simple premises â€” never becomes the gold standard for reasoning. Other civilizations develop their own mathematics and philosophy, but the specific Western tradition of deductive proof, formal logic, and systematic inquiry either doesn't emerge or emerges centuries later from different roots.",
    modernWorld: [
      {area: "Education", detail: "Universities don't exist in their current form â€” the Platonic academy was the prototype. Higher learning develops through apprenticeship, religious instruction, and guild systems instead. The idea of liberal arts as a curriculum has no anchor."},
      {area: "Science", detail: "Without Euclid's axiomatic method, mathematical proof develops differently. Islamic mathematicians likely lead â€” al-Khwarizmi's algebra fills some of the gap â€” but the geometric foundations of physics are weaker. Newton's Principia, modeled explicitly on Euclid, never takes that form."},
  ...
  },
  {
    ...
    compoundEffect: "Rutherford discovers the atomic nucleus. Bohr builds the first working model of the atom. Fermi builds the first nuclear reactor. Remove all three and the atomic age is delayed by decades. Other physicists â€” Chadwick, Heisenberg, Oppenheimer â€” were brilliant but dependent on this chain. Without Rutherford's nucleus, atomic physics stalls in the 1910s. Without Bohr's model, quantum mechanics develops from different starting assumptions and much more slowly. Without Fermi's engineering genius, even if the theory eventually arrives, nobody knows how to build a working reactor.",
    modernWorld: [
      {area: "War", detail: "No atomic bomb in WWII. The Pacific war ends with Operation Downfall â€” the invasion of Japan â€” costing an estimated 500,000+ Allied and millions of Japanese casualties. The Cold War is purely conventional. No MAD, no nuclear deterrence."},
      {area: "Energy", detail: "No nuclear power plants. France still burns coal. Climate change is arguably worse (no nuclear baseload) or arguably the same (fossil fuel interests were always going to dominate). The entire nuclear debate â€” waste, proliferation, meltdowns â€” never happens."},
  ...
  },
  {
    ...
    modernWorld: [
      ...
      {area: "Culture", detail: "American identity is fundamentally different. The Civil War â€” if it happens â€” is fought over economics, not freedom. Lincoln isn't martyred. There's no Gettysburg Address. The American mythology of equality as aspiration barely exists."}
    ]
  },
  {
  ...
  },
  {
    ...
    modernWorld: [
      ...
      {area: "World Wars", detail: "Both World Wars see far higher casualty rates from wound infection. Penicillin's absence in WWII is devastating â€” in our timeline it saved an estimated 12-15% of wounded soldiers who would have died from infection."},
  ...
  },
  {
    ...
    compoundEffect: "Magna Carta establishes that even kings answer to law. The American Revolution proves you can build a republic from scratch. The French Revolution demonstrates that the people can overthrow monarchy entirely. Remove all three and the trajectory of democratic governance changes. Democracy as an idea still exists (it's ancient Greek), but its modern form â€” constitutional government, individual rights, representative legislatures â€” lacks its three defining proof cases. Monarchies and empires persist much longer. Self-governance arrives eventually (industrialization and literacy create pressure), but the timeline shifts by a century.",
    modernWorld: [
      ...
      {area: "Daily Life", detail: "You might live in a monarchy. Your relationship to government is more like a subject than a citizen. Freedom of speech, religion, and assembly are privileges, not rights. Voting â€” if it exists â€” is limited to landed elites."}
    ]
  },
  {
    id: "no_art_titans",
    ...
    compoundEffect: "Leonardo defines the Renaissance ideal: art and science as one endeavor. Shakespeare invents the modern interior life in fiction â€” his characters think, doubt, contradict themselves. Beethoven breaks music free from aristocratic patronage and invents the idea of the artist as heroic individual. Remove all three and Western culture still produces great art, but the specific idea of the lone creative genius â€” the figure who transforms an entire medium through sheer force of vision â€” doesn't crystallize until much later. Art remains more institutional, more collaborative, more craftsman-like.",
    modernWorld: [
      {area: "Language", detail: "Shakespeare coined over 1,700 English words and phrases. No 'lonely,' no 'eyeball,' no 'bedroom,' no 'break the ice,' no 'wild goose chase.' The English language is measurably smaller. The modern psychological novel develops later â€” who shows characters' inner lives without Hamlet as the template?"},
  ...
  },
  {
    ...
    compoundEffect: "Humboldt invented the idea that nature is an interconnected system â€” before him, people studied individual species and rocks, not ecosystems. Carson proved that industrial chemicals could poison entire food chains, launching the modern environmental movement. Goodall demonstrated that animals have emotional and social lives, changing humanity's relationship with other species. Without all three, environmentalism still exists (pollution is visible), but the intellectual framework â€” that everything is connected, that human industry has systemic effects, that animals deserve moral consideration â€” develops later and from different roots.",
    modernWorld: [
      ...
      {area: "Climate Change", detail: "Without the Humboldtian tradition of seeing Earth as an interconnected system, climate science develops more slowly. The concept of 'ecosystem' doesn't exist in its current form. When scientists eventually raise the alarm about COâ‚‚, they lack the vocabulary and framework to explain why it matters."},
  ...
  },
  {
    ...
    modernWorld: [
      ...
      {area: "Daily Life", detail: "Without Smith's Wealth of Nations, free-market capitalism still develops (it was already happening), but governments intervene more in trade â€” mercantilism persists longer. Without Keynes, your government doesn't send stimulus checks during recessions. Without Marx, your college doesn't have a sociology department in its current form."}
    ]
  }
];
